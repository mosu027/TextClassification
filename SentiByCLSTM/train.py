...
from clstm_model import clstm_clf
...
stopwords_path = "../Conf/stopwords.txt"
...
# Data parameters
tf.flags.DEFINE_string('data_file', train_path, 'Data file path')
tf.flags.DEFINE_string('stop_word_file', stopwords_path, 'Stop word file path')
...
outdir = os.path.abspath(os.path.join(rootPath, "runs_CLSTM", curTime()))
...
data, labels, lengths, vocab_processor = processData.load_data(file_path=FLAGS.data_file,
