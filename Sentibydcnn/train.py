...
# Load data
print("Loading data...")
x_, y_, vocabulary, vocabulary_inv, test_size = datapreprocess.load_data()
...
sent = tf.placeholder(tf.int64, [None, sentence_length], name="input_x")
...
with tf.Session() as sess:
    ...
    batches = datapreprocess.batch_iter(zip(x_train, y_train), batch_size, n_epochs)
